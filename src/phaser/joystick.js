...
export default class Joystick {
  ...
  constructor (scene, call) {
    ...
    // this.stick.on('dragstart', this.onDragStartStick.bind(this))
    // this.stick.on('drag', this.onDragStick.bind(this))
    // this.stick.on('dragend', this.onDragEndStick.bind(this))
    ...
    // this.barrelLeft.on('pointerdown', () => {
    //   this.barrelLeft.setAlpha(0.6)
    //   this.call('barrel', -1)
    // })
    // this.barrelLeft.on('pointerup', () => {
    ...
    // this.barrelRight.on('pointerdown', () => {
    //   this.barrelRight.setAlpha(0.6)
    //   this.call('barrel', 1)
    // })
    // this.barrelRight.on('pointerup', () => {
  ...
  onPointerDown (pointer, gameObjects, dragX, dragY) {
    ...
    console.log('onPointerDown', gameObject)
  ...
  onPointerUp (pointer, gameObjects, dragX, dragY) {
    ...
    console.log('onPointerUp', gameObject)
    switch (gameObject.getData('itemType')) {
      case 'stick':
